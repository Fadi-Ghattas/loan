...
Route::group(['prefix' => 'loan'], function () {
	...
	Route::get('{loan}/payment-on-account/create', 'LoanController@createPaymentOnAccount');
	Route::post('{loan}/payment-on-account/store', 'LoanController@storePaymentOnAccount');
